            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/user" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="cell_number" class="col-md-4 col-form-label text-md-right">{{ __('Phone Number') }}</label>

                            <div class="col-md-6">
                                <input id="cell_number" type="text" class="form-control @error('cell_number') is-invalid @enderror" name="cell_number" value="{{ old('cell_number') }}" required autocomplete="cell_number">
                        ...
                        <!-- Username section -->
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('Username') }}</label>

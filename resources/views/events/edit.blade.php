...
<div class="container">
    <h1>Edit event</h1>
<form id="editForm" action='/event/{{$event->id}}' method="POST">
        <!-- Add form token -->
        {{ csrf_field() }}
        ...
        <div class="form-group">
                ...
                <input value={{$event->start_date}} type="text" name="startDate" class="form-control" placeholder="YYYY-MM-DD" id="startDate">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
                ...
                {{ Form::select ('status', ['Active' => 'Active', 'Archive' => 'Archive'], $event->status , ['id' =>'eventStatus', 'class'=>'custom-select']) }}
        </div>
